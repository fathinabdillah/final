...
<body>
	...
	<div class="container" style="margin-top: 80px">
		<div class="col-md-12">
			<form action="<?php echo site_url('hmif/update_hmif/'.$b->id_hmif)?>" method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="jabatan_hmif" value="<?php echo $b->jabatan_hmif ?>" class="form-control" >
			  </div>

			  <div class="form-group">
			    <label for="text">Foto</label>
			    <input type="file" name="foto_hmif" value="<?php echo $b->foto_hmif ?>" class="form-control" >
			  </div>
